<template>
  <div style="z-index: 20110;" class="upload-image">
    ...
    <!--    -->
    <div v-if="dialogVisible"  @click="close" class="addLeft" style="z-index: 30120;position: fixed;top: 0;left: 0;width: 100%;height: 100%;background-color:rgba(0,0,0,0.6);display: flex;justify-content: center;align-items: center">
