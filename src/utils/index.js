...
export function recLoadPriceFilter (value) {
  if (value.recLoadPrice != null) {
    let realVal = numToFixed(value.recLoadPrice, moneyLength);
    return realVal;
  }
  return '';
...
export function payLoadPriceFilter (value) {
  if (value.payLoadPrice != null) {
    let realVal = numToFixed(value.payLoadPrice, moneyLength);
    return realVal;
  }
  return '';
...
export function recUnloadPriceFilter (value) {
  if (value.recUnloadPrice != null) {
    let realVal = numToFixed(value.recUnloadPrice, moneyLength);
    return realVal;
  }
  return '';
...
export function payUnloadPriceFilter (value) {
  if (value.payUnloadPrice != null) {
    let realVal = numToFixed(value.payUnloadPrice, moneyLength);
    return realVal;
  }
  return '';
...
export function payPriceFilter (value) {
  if (value.payPrice != null) {
    let realVal = numToFixed(value.payPrice, feeLength);
    return realVal;
  }
  return '';
...
export function recPriceFilter (value) {
  ...
  if (value.recPrice != null) {
    let realVal = numToFixed(value.recPrice, feeLength);
    return realVal;
  }
  return '';
}
...
export function uniUnloadPriceFilter (value) {
  ...
  if (value.uniUnloadPrice != null) {
    let realVal = numToFixed(value.uniUnloadPrice, feeLength);
    return realVal;
  }
  return '';
...
export function appUnloadPriceFilter (value) {
  if (value.appUnloadPrice != null) {
    let realVal = numToFixed(value.appUnloadPrice, feeLength);
    return realVal;
  }
  return '';
...
export function pickUpPriceFilter (value) {
  if (value.pickUpPrice != null) {
    let realVal = numToFixed(value.pickUpPrice, feeLength);
    return realVal;
  }
  return '';
...
export function deliveryPriceFilter (value) {
  ...
  if (value.deliveryPrice != null) {
    let realVal = numToFixed(value.deliveryPrice, feeLength);
    return realVal;
  }
  return '';
...
export function loadPriceFilter (value) {
  ...
  if (value.loadPrice != null) {
    let realVal = numToFixed(value.loadPrice, feeLength);
    return realVal;
  }
  return '';
}
...
export function payTransPriceFilter (value) {
  ...
  if (value.payTransPrice != null) {
    let realVal = numToFixed(value.payTransPrice, feeLength);
    return realVal;
  }
  return '';
}
...
export function payTransFeeFilter (value) {
  ...
  if (value.payTransFee != null) {
    let realVal = numToFixed(value.payTransFee, feeLength);
    return realVal;
  }
  return '';
}
...
export function diffFeeFilter (value) {
  ...
  if (value.diffFee != null) {
    let realVal = numToFixed(value.diffFee, feeLength);
    return realVal;
  }
  return '';
}
...
export function payUniUnloadPriceFilter (value) {
  ...
  if (value.payUniUnloadPrice != null) {
    let realVal = numToFixed(value.payUniUnloadPrice, feeLength);
    return realVal;
  }
  return '';
}
...
export function payAppUnloadPriceFilter (value) {
  ...
  if (value.payAppUnloadPrice != null) {
    let realVal = numToFixed(value.payAppUnloadPrice, feeLength);
    return realVal;
  }
  return '';
}
...
export function payAdditionFeeFilter (value) {
  if (value.payAdditionFee != null) {
    let realVal = numToFixed(value.payAdditionFee, 2);
    return realVal;
  }
  return '';
} export function payDeductionFeeFilter (value) {
  if (value.payDeductionFee != null) {
    let realVal = numToFixed(value.payDeductionFee, 2);
    return realVal;
  }
  return '';
}
export function payTotalFilter (value) {
  if (value.payTotal != null) {
    let realVal = numToFixed(value.payTotal, 2);
    return realVal;
  }
  return '';
}
export function recTotalFilter (value) {
  if (value.recTotal != null) {
    let realVal = numToFixed(value.recTotal, 2);
    return realVal;
  }
  return '';
}
export function profitFilter (value) {
  if (value.profit != null) {
    let realVal = numToFixed(value.profit, 2);
    return realVal;
  }
  return '';
}
...
export function orderWtFilter (value) {
  if (value.orderWt != null) {
    let realVal = numToFixed(value.orderWt, wtLength);
    return realVal;
  }
  return '';
}
...
export function actWtFilter (value) {
  if (value.actWt != null) {
    let realVal = numToFixed(value.actWt, wtLength);
    return realVal;
  }
  return '';
}
...
export function arrWtFilter (value) {
  if (value.arrWt != null) {
    let realVal = numToFixed(value.arrWt, wtLength);
    return realVal;
  }
  return '';
}
...
export function setBillFormatRecTotal (value) {
  if (value.recTotal != null) {
    let tempVal = parseFloat(value.recTotal).toFixed(2);
    return tempVal;
  } else {
    return null;
  }
...
export function setBillFormatPayTotal (value) {
  if (value.payTotal != null) {
    let tempVal = parseFloat(value.payTotal).toFixed(2);
    return tempVal;
  } else {
    return null;
  }
...
export function setWhFeeFormatRecTotalRent (value) {
  if (value.recTotalRent != null) {
    let tempVal = parseFloat(value.recTotalRent).toFixed(2);
    return tempVal;
  } else {
    return null;
  }
...
export function setWhFeeFormatRecTotalWt (value) {
  if (value.recTotalWt != null) {
    let tempVal = parseFloat(value.recTotalWt).toFixed(2);
    return tempVal;
  } else {
    return null;
  }
...
export function setWhFeeFormatPayTotalRent (value) {
  if (value.payTotalRent != null) {
    let tempVal = parseFloat(value.payTotalRent).toFixed(2);
    return tempVal;
  } else {
    return null;
  }
...
export function setWhFeeFormatPayTotalWt (value) {
  if (value.payTotalWt != null) {
    let tempVal = parseFloat(value.payTotalWt).toFixed(2);
    return tempVal;
  } else {
    return null;
  }
...
export function setWhFeeFormatAdjPayTotalRent (value) {
  if (value.adjPayTotal != null) {
    let tempVal = parseFloat(value.adjPayTotal).toFixed(2);
    return tempVal;
  } else {
    return null;
  }
...
export function setWhFeeFormatAdjRecTotalRent (value) {
  if (value.adjRecTotal != null) {
    let tempVal = parseFloat(value.adjRecTotal).toFixed(2);
    return tempVal;
  } else {
    return null;
  }
...
export const setPageLimit = (pageRequest, queryVo) => {
  const firstPage = 1;
  pageRequest.page = pageRequest.page || firstPage;
  queryVo.page = pageRequest.page || firstPage;
