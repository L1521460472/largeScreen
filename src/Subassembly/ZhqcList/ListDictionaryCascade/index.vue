  ...
  export default {
    ...
    data() {
      return {
        ...
        list: [],
        loading: false,
        listUrl: process.env.WMS_MODEL+'/base/tm/dictionaryDt/queryDictionaryCbList',
        itemUrl: process.env.WMS_MODEL+'/base/tm/dictionaryDt/initUpdate/',
      };
    },
    methods: {
      /**
      ...
      getList() {
        ...
        return new Promise((resolve, reject) => {
          let data = {'dicTypeCode':this.tempDicTypeCode}
