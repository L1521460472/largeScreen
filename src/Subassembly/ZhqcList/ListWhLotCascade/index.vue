  ...
  export default {
    ...
    data() {
      return {
        ...
        list: [],
        loading: false,
        listUrl: process.env.WMS_MODEL+'/base/wh/whLot/queryWhLotCbListByZoneId',
        itemUrl: process.env.WMS_MODEL+'/base/wh/whLot/initUpdate/',
      };
    },
    methods: {
      /**
      ...
      getList(queryText) {
        ...
        return new Promise((resolve, reject) => {
          let data = {'zoneId':this.whZoneId,'queryText':queryText}
