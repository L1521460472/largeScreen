  ...
  export default {
    ...
    data() {
      return {
        ...
        list: [],
        loading: false,
        listUrl: process.env.WMS_MODEL+'/ob/waveModel/queryCbList',
        itemUrl: process.env.WMS_MODEL+'/ob/waveModel/queryCb/',
      };
    },
    methods: {
      /**
       ...
       */
      listApi(queryText) {
        let data = {modelName: queryText, page: this.$globalPage, limit: this.$globalLimit};
        return service({
          url: this.listUrl,
          method: 'post',
          data
